...
goHomeBtn.addEventListener('click',()=>{
    window.location.href="/coordinated-crib-6423-carters.com/index.html";
})
...
checkOut.addEventListener('click',()=>{
    ...
    window.location.href="/coordinated-crib-6423-carters.com/MohdSharique/checkoutForm.html";
    temp = 0;
})
